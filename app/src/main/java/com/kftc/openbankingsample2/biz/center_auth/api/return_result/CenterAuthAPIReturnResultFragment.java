package com.kftc.openbankingsample2.biz.center_auth.api.return_result;
 ...
 * 자금반환결과조회
 */
public class CenterAuthAPIReturnResultFragment extends AbstractCenterAuthMainFragment {
    ...
    void initView() {
        ...
        etBankTranDate.setText(Utils.getSavedValueOrDefault(CenterAuthConst.CENTER_AUTH_BANK_TRAN_DATE, etBankTranDate.getText().toString()));
        ...
        view.findViewById(R.id.btnNext).setOnClickListener(v -> {
            ...
            Utils.saveData(CenterAuthConst.CENTER_AUTH_BANK_TRAN_DATE, bankTranDate);
