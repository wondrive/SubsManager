...
class RecommendDao {
    ...
    fun resultList(): List<RecommendEntity> = resultList   // getter
    ...
    fun selectRecommendList(selectCategory: String): List<RecommendEntity> {
        ...
        categoryQuery.document("1").get()
            .addOnSuccessListener {
                ...
                subsQuery.whereEqualTo("categoryId", 1)//category?.id.toLong())
